...
**Ella:** I learned a lot about time management while developing this project. A 10 week turnaround is steeper than it sounds, and other classes on top of CrazyCollab created a lot of time constraints. I also learned quite a bit more about frontend development, as I have most experience with Drupal. Building our UI from scratch was a refresher to me, and I needed to take several steps back during development as I was finding an approach to create new components. Overall, this has given me a much more well rounded understanding of program development, especially in front end and UI development.
